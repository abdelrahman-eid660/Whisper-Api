...
import { confirm2Step_Verification, deleteAccount, enable2Step_Verification, logout, profile, profileCover, profilePicture, rotateToken, shareProfile, updatePassword } from "./user.service.js";
...
import { cloudFileUpload, fieldValidation } from "../../common/utils/index.js";
import * as validators from './user.validation.js'
const router = Router();
router.get("/", authorization({accessRole : endPoint.Profile}) ,async (req, res, next) => {
